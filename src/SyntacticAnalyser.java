...
public class SyntacticAnalyser {
	...
	public static ParseTree<Token> parse(List<Token> tokens) throws SyntaxException {
		parseTree = new ParseTree<Token>();
		i = 0;
		root = parseTree.new TreeNode(ParseTree.Label.prog);
		nodes = new ArrayList<ParseTree<Token>.TreeNode>();
...
//		System.out.println(parseTree.getRoot().getChildren() + " Test");
	...
	public static void progNT(List<Token> tokens) throws SyntaxException {
		if (tokens.get(i).getType().equals(Token.TokenType.PUBLIC)) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.terminal, tokens.get(i), root));
		...
		if (tokens.get(i).getType().equals(Token.TokenType.STRINGARR)) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.terminal, tokens.get(i), root));
			root.addChild(parseTree.new TreeNode(ParseTree.Label.terminal, tokens.get(i), root));
		} else {throw new SyntaxException("Syntax Exception");}
		i++;
...
//			System.out.println(parseTree.getRoot().getChildren() + "  rr");
		...
		} else if (tokens.get(i+1).getType().equals(Token.TokenType.RBRACE)) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.los, root));
			root.addChild(nodes.get(nodes.size()-1));
			losNT(tokens);
		} 
	...
	public static void losNT(List<Token> tokens) throws SyntaxException {
		...
		if (tokens.get(i).getStringValue().matches(";|while|for|if|System\\.out\\.println|[(]|int|boolean|char") || tokens.get(i).getType().equals(Token.TokenType.ID)) {
			...
			losParent.addChild(parseTree.new TreeNode(ParseTree.Label.epsilon, losParent));
		} 
		else {throw new SyntaxException("Syntax Exception");}
	...
	public static void statNT(List<Token> tokens) throws SyntaxException {
		...
		if (tokens.get(i).getType().equals(Token.TokenType.WHILE)) {
			...
			statParent.addChild(nodes.get(nodes.size()-1));
			assignNT(tokens);
			nodes.add(parseTree.new TreeNode(ParseTree.Label.terminal,tokens.get(i), statParent));
		} else if (tokens.get(i).getType().equals(Token.TokenType.TYPE)) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.decl, statParent));
			statParent.addChild(nodes.get(nodes.size()-1));
			declNT(tokens);
			nodes.add(parseTree.new TreeNode(ParseTree.Label.terminal,tokens.get(i-1), statParent));
			statParent.addChild(nodes.get(nodes.size()-1));
	...
	public static void whileNT(List<Token> tokens) throws SyntaxException {
		...
		if (tokens.get(i).getType().equals(Token.TokenType.ID) || tokens.get(i).getType().equals(Token.TokenType.NUM) || tokens.get(i).getValue().get().matches("true|false|\\(")) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.boolexprprime, whileParent));
			whileParent.addChild(nodes.get(nodes.size()-1));
			boolExprNT(tokens);
			whileParent.addChild(parseTree.new TreeNode(ParseTree.Label.whilestat, tokens.get(i), whileParent));
		} else {throw new SyntaxException("Syntax Exception");}
	...
	public static void forNT(List<Token> tokens) throws SyntaxException {
		...
		i++;
		System.out.println(tokens.get(i) + "285");
		...
		if (tokens.get(i).getStringValue().matches("true|false|\\(") || tokens.get(i).getType().equals(Token.TokenType.NUM) || tokens.get(i).getType().equals(Token.TokenType.ID)) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.boolexprprime, forParent));
			forParent.addChild(nodes.get(nodes.size()-1));
			boolExprNT(tokens);
		} else {throw new SyntaxException("Syntax Exception");}
		//i++;
	...
	public static void ifNT(List<Token> tokens) throws SyntaxException { ////
		...
		if (tokens.get(i).getStringValue().matches(";|while|for|if|System\\.out\\.println|\\(|int|boolean|char")) { //FIXED
	...
	public static void elseIfNT(List<Token> tokens) throws SyntaxException {
		...
		if (tokens.get(i).getType().equals(Token.TokenType.ELSE) || tokens.get(i).getType().equals(Token.TokenType.IF)) {	
			System.out.println(tokens.get(i) + "426");
			...
			i++;
			System.out.println(tokens.get(i).getStringValue() + "440");
			if (tokens.get(i).getStringValue().matches(";|while|for|if|System\\.out\\.println|\\(|int|boolean|char") || tokens.get(i).getType().equals(Token.TokenType.ID)) { //FIXED
			...
			System.out.println(tokens.get(i) + "459");
			if (tokens.get(i).getType().equals(Token.TokenType.RBRACE)) {
				nodes.add(parseTree.new TreeNode(ParseTree.Label.elseifstat,tokens.get(i), elseIfParent));
				elseIfParent.addChild(nodes.get(nodes.size()-1));
			} else {throw new SyntaxException("Syntax Exception");}
			...
			if (tokens.get(i).getType().equals(Token.TokenType.ELSE) || tokens.get(i).getStringValue().matches(";|while|for|if|system\\.out\\.print|\\(|int|boolean|char|//}") || tokens.get(i).getType().equals(Token.TokenType.RBRACE)) {
				nodes.add(parseTree.new TreeNode(ParseTree.Label.elseifstat,tokens.get(i), elseIfParent));
				elseIfParent.addChild(nodes.get(nodes.size()-1));
				elseIfNT(tokens);
				} else {throw new SyntaxException("Syntax Exception");}
			...
			System.out.println(tokens.get(i) + "475");
			throw new SyntaxException("Syntax Exception");}
...
//		i++;
	...
	public static void elseQIfNT(List<Token> tokens) throws SyntaxException {
		...
		i++;
		System.out.println(tokens.get(i) + "578");
		if (tokens.get(i).getType().equals(Token.TokenType.IF) || tokens.get(i).getType().equals(Token.TokenType.LBRACE)) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.elseifstat,tokens.get(i), elseQIfParent));
			elseQIfParent.addChild(nodes.get(nodes.size()-1));
			possIfNT(tokens);
			} else {throw new SyntaxException("Syntax Exception");}
	...
	public static void possIfNT(List<Token> tokens) throws SyntaxException {
		...
		System.out.println(tokens.get(i) + "590");
		if (tokens.get(i).getType().equals(Token.TokenType.IF)) {
			if (tokens.get(i).getType().equals(Token.TokenType.IF)) {
			...
			if (tokens.get(i).getType().equals(Token.TokenType.ID) || tokens.get(i).getType().equals(Token.TokenType.NUM) || tokens.get(i).getValue().get().matches("true|false|\\(")) {
				nodes.add(parseTree.new TreeNode(ParseTree.Label.boolexprprime, possIfParent));
				possIfParent.addChild(nodes.get(nodes.size()-1));
				boolExprNT(tokens);
			} else {throw new SyntaxException("Syntax Exception");}
			...
			i++;
		} else if (tokens.get(i).getType().equals(Token.TokenType.LBRACE)) {
	...
	public static void declNT(List<Token> tokens) throws SyntaxException {
		...
		if (tokens.get(i).getType().equals(Token.TokenType.ID)) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.terminal, tokens.get(i), declParent));
			declParent.addChild(nodes.get(nodes.size()-1));
			idNT(tokens);
		} else {throw new SyntaxException("Syntax Exception");}
		i++;
		
		System.out.println(tokens.get(i) + "666");
		if (tokens.get(i).getType().equals(Token.TokenType.ASSIGN) || tokens.get(i).getType().equals(Token.TokenType.SEMICOLON)) {
	...
	public static void possAssignNT(List<Token> tokens) throws SyntaxException {
		...
		if (tokens.get(i).getType().equals(Token.TokenType.ASSIGN)) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.terminal,tokens.get(i), possAssignParent));
			...
			if (tokens.get(i).getStringValue().matches("true|false|\\(") || tokens.get(i).getType().equals(Token.TokenType.NUM) || tokens.get(i).getType().equals(Token.TokenType.ID) || tokens.get(i).getType().equals(Token.TokenType.SQUOTE)) {
				nodes.add(parseTree.new TreeNode(ParseTree.Label.expr, tokens.get(i), possAssignParent));
				possAssignParent.addChild(nodes.get(nodes.size()-1));
				exprNT(tokens);
			} else {throw new SyntaxException("Syntax Exception");}
			...
			//nodes.add(parseTree.new TreeNode(ParseTree.Label.epsilon,tokens.get(i), possAssignParent));
			System.out.println(tokens.get(i) + "692");
			possAssignParent.addChild(parseTree.new TreeNode(ParseTree.Label.epsilon,new Token(Token.TokenType.SEMICOLON), possAssignParent));
	...
	public static void typeNT(List<Token> tokens) throws SyntaxException {
		...
		if (tokens.get(i).getType().equals(Token.TokenType.TYPE)) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.terminal, tokens.get(i), typeParent));
	...
	public static void exprNT(List<Token> tokens) throws SyntaxException {
		...
		if (tokens.get(i).getStringValue().matches("true|false|\\(")) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.relexpr, exprParent));
			exprParent.addChild(nodes.get(nodes.size()-1));
			nodes.get(nodes.size()-1).addChild(parseTree.new TreeNode(ParseTree.Label.terminal, tokens.get(i), exprParent));
			nodes.add(parseTree.new TreeNode(ParseTree.Label.boolexprprime, exprParent));
			exprParent.addChild(nodes.get(nodes.size()-1));
//			nodes.get(nodes.size()-2).addChild(parseTree.new TreeNode(ParseTree.Label.relexpr, exprParent));
			boolExprNT(tokens);
			...
			nodes.add(parseTree.new TreeNode(ParseTree.Label.charexpr, exprParent)); //char Expr
			exprParent.addChild(nodes.get(nodes.size()-1));
			charExprNT(tokens);
		} 
		else {throw new SyntaxException("Syntax Exception");}
	...
	public static void relExprNT(List<Token> tokens) throws SyntaxException {
		...
		if (tokens.get(i).getType().equals(Token.TokenType.ID) || tokens.get(i).getType().equals(Token.TokenType.NUM) || tokens.get(i).getStringValue().matches("[)]|[;]|[<]|[<>]=?|=|\\!\\=|\\&\\&|\\|")) {
			...
			if (tokens.get(i).getType().equals(Token.TokenType.LT) || tokens.get(i).getType().equals(Token.TokenType.LE) || tokens.get(i).getType().equals(Token.TokenType.GT) || tokens.get(i).getType().equals(Token.TokenType.GE) || tokens.get(i-1).getType().equals(Token.TokenType.NUM)) {
			...
			nodes.add(parseTree.new TreeNode(ParseTree.Label.boolexprprime,tokens.get(i), relExprParent));
			relExprParent.addChild(nodes.get(nodes.size()-1));
	...
	public static void printExprNT(List<Token> tokens) throws SyntaxException {
		...
		if (tokens.get(i).getStringValue().matches("true|false|\\(") || tokens.get(i).getType().equals(Token.TokenType.NUM) || tokens.get(i).getType().equals(Token.TokenType.ID)) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.boolexprprime, printExprParent));
	...
	public static void charExprNT(List<Token> tokens) throws SyntaxException {
		...
		if (tokens.get(i).getType().equals(Token.TokenType.SQUOTE)) {
			nodes.add(parseTree.new TreeNode(ParseTree.Label.terminal, tokens.get(i), charExprParent));
